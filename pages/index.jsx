  ...
  return (
    <Fragment>
      ...
      <main class="py-16 text-white">
          ...
          href={'/recipeList/1'}>Visit Recipes</Link>
      
        <section className="container mx-auto px-4">
          <h2 className="text-3xl font-bold">The Recipe App: A Culinary Adventure</h2>
          <p className="mt-4 text-lg">
            The Recipe App is a culinary
            adventure that will take you on a journey around the world,
            introducing you to new and exciting flavors from every corner of the
            globe. With its extensive collection of recipes from both
            traditional and modern cuisines, The Recipe App has something for
            everyone, from the novice cook to the seasoned chef. But what really
            sets The Recipe App apart is its focus on unorthodox tastes. Whether
            you're looking for a dish that combines sweet and savory flavors,
            uses unusual ingredients, or offers a unique culinary experience,
            The Recipe App has you covered.
          </p>
